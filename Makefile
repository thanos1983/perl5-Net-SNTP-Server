# This Makefile is for the Net::SNTP::Server extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Net/SNTP/Server.pm]
...
#     META_MERGE => { resources=>{ repository=>{ type=>q[git], url=>q[https://github.com/thanos1983/perl5-Net-SNTP-Server.git], web=>q[https://github.com/thanos1983/perl5-Net-SNTP-Server] } }, meta-spec=>{ version=>q[6] } }
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Net/SNTP/Server.pm
...
TO_INST_PM = lib/Net/SNTP/Server.pm

PM_TO_BLIB = lib/Net/SNTP/Server.pm \
...
DISTVNAME = Net-SNTP-Server-0.06
...
manifypods : pure_all  \
	lib/Net/SNTP/Server.pm
	$(NOECHO) $(POD2MAN) --section=$(MAN3EXT) --perm_rw=$(PERM_RW) \
	  lib/Net/SNTP/Server.pm $(INST_MAN3DIR)/Net::SNTP::Server.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'abstract: '\''Perl Module SNTP Server based on L<RFC4330|https://tools.ietf.org/html/rfc4330>'\''' >> META_new.yml
	$(NOECHO) $(ECHO) 'author:' >> META_new.yml
	$(NOECHO) $(ECHO) '  - "Athanasios Garyfalos <garyfalos@cpan.org\x02>"' >> META_new.yml
	...
	$(NOECHO) $(ECHO) 'name: Net-SNTP-Server' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   "abstract" : "Perl Module SNTP Server based on L<RFC4330|https://tools.ietf.org/html/rfc4330>",' >> META_new.json
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "Net-SNTP-Server",' >> META_new.json
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>Perl Module SNTP Server based on L&lt;RFC4330|https://tools.ietf.org/html/rfc4330&gt;</ABSTRACT>' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/Net/SNTP/Server.pm blib/lib/Net/SNTP/Server.pm 
